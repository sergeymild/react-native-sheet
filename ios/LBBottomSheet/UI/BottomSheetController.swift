...
internal extension BottomSheetController {
    static func controller(bottomSheetChild: UIViewController,
        ...
        let bottomController: BottomSheetController = UIStoryboard(name: "BottomSheet", bundle: Bundle(for: BottomSheetController.self)).instantiateInitialViewController() as! BottomSheetController
