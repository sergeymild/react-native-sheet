 ...
 * `getContentOriginOffset` lets the Swift side (`HostFittedSheet`) push a
 * visual X/Y delta via state updates after child-VC containment for inline
 * presentation. The offset is consumed by
